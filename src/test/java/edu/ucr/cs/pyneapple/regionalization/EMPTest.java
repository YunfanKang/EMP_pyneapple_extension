...
public class EMPTest extends TestCase {
    ...
    /**
     * The test case for the itereated greedy EMP
     * @throws Exception Exception when the shapefile cannot be loaded or the attributes of the corresponding name does not exist in the shapefile.
     */
    public void test_iterated_greedy() throws Exception{
        /*EMP_IterativeGreedy.set_input(negativeDataset,
                "pop_16up",
                1000.0,
                Double.POSITIVE_INFINITY,
                "unemployed",
        ...
        EMP_IterativeGreedy.set_input_minmax_norepeat(negativeDataset,
                "pop_16up",
                -Double.POSITIVE_INFINITY,
                Double.POSITIVE_INFINITY,
                "unemployed",
    ...
    /**
     * The test case for the EMP modular version
     * @throws Exception Exception when the shapefile cannot be loaded or the attributes of the corresponding name does not exist in the shapefile.
     */
    public void test_break_down() throws Exception{
        EMP_breakdown.set_input(negativeDataset,
                "pop_16up",
                1000.0,
                Double.POSITIVE_INFINITY,
                "unemployed",
        ...
        EMP_breakdown.set_input_minmax_norepeat(negativeDataset,
                "pop_16up",
                1000.0,
                Double.POSITIVE_INFINITY,
                "unemployed",
