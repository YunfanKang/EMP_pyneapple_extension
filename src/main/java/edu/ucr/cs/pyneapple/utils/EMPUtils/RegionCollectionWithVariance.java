 ...
 */
public class RegionCollectionWithVariance implements Serializable {
    private int max_p;
    private int[] labels;
    private Map<Integer, RegionWithVariance> regionMap;
     ...
     */
    public RegionCollectionWithVariance(int m, int[] l, Map<Integer, RegionWithVariance> rl){
        max_p = m;
        labels = l;
        regionMap = rl;
     ...
     */
    public RegionCollectionWithVariance(){
        max_p = 0;
        labels = null;
        regionMap = null;
        //regionSpatialAttr = null;
     ...
     */
    public Map<Integer, RegionWithVariance> getRegionMap(){
        return regionMap;
    }
